          ...
          <div className="mx-0 lg:mx-52">
            <Card title="ข้อมูลข่าวประชาสัมพันธ์" bordered={true}>
              <Form form={form} size="large" name="form" labelCol={{ span: 4 }} onFinish={onFinish} autoComplete="off">
                ...
                <Form.Item label="ชื่อบทความ" name="name" rules={[{ required: true, message: "กรุณากรอกชื่อบทความ" }]}>
                  <Input />
                </Form.Item>

                <Form.Item name="image" label="ภาพบทความ" valuePropName="file" getValueFromEvent={handleOnUploadShowImagePreview}>
